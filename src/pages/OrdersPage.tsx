...
const allOrders = [
  { id: '#1910213', client: 'Алексей Морозов', phone: '+7 999 123-45-67', amount: '₽3 400', status: 'Новый', date: '11.05.2026', items: 2 },
  { id: '#1910212', client: 'Маша Иванова', phone: '+7 912 234-56-78', amount: '₽7 800', status: 'В работе', date: '11.05.2026', items: 5 },
  { id: '#1910211', client: 'Дмитрий Соколов', phone: '+7 925 345-67-89', amount: '₽1 200', status: 'Готов', date: '11.05.2026', items: 1 },
  { id: '#1910210', client: 'ООО "Техносила"', phone: '+7 495 456-78-90', amount: '₽22 500', status: 'Доставка', date: '11.05.2026', items: 12 },
  { id: '#1910209', client: 'Кристина Волкова', phone: '+7 903 567-89-01', amount: '₽5 600', status: 'Выполнен', date: '10.05.2026', items: 3 },
  { id: '#1910208', client: 'Игорь Петров', phone: '+7 916 678-90-12', amount: '₽9 100', status: 'Выполнен', date: '10.05.2026', items: 6 },
  { id: '#1910207', client: 'Анна Сидорова', phone: '+7 985 789-01-23', amount: '₽2 300', status: 'Отменён', date: '10.05.2026', items: 2 },
  { id: '#1910206', client: 'ИП Козлов А.В.', phone: '+7 977 890-12-34', amount: '₽14 700', status: 'Выполнен', date: '10.05.2026', items: 9 },
  { id: '#1910205', client: 'Наталья Белова', phone: '+7 926 901-23-45', amount: '₽4 200', status: 'Новый', date: '10.05.2026', items: 3 },
